...
const fromEmail = process.env.SENDGRID_FROM_EMAIL ?? "noreply@snapcard.app";
...
export async function sendWelcomeEmail(email: string, name: string | null): Promise<void> {
  ...
  await send(
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>
        <a href="${process.env.FRONTEND_URL ?? "https://snapcard.app"}/onboarding"
  ...
  await send(
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="color: #666; font-size: 14px; margin-top: 24px;">
        ...
        <a href="${process.env.FRONTEND_URL ?? "https://snapcard.app"}/dashboard">SnapCard Dashboard</a>.
      </p>
    </div>
    `
  );
...
export async function sendListingErrorEmail(
  ...
  await send(
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>
        <a href="${process.env.FRONTEND_URL ?? "https://snapcard.app"}/dashboard"
           style="display: inline-block; padding: 10px 24px; background: #18181b; color: #fff; border-radius: 6px; text-decoration: none;">
          Go to Dashboard
        </a>
      </p>
